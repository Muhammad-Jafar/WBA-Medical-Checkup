...
<div class="page-portrait">
    ...
    <o:p></o:p>
        <p style="font-family: 'Arial', sans-serif; font-size:12pt; text-align:justify; line-height:1.5">
            ...
            Hal ini menjalankan tugasnya dengan mengingat sumpah yang telah diucapkan waktu menerima jabatan,
        ...
        <o:p></o:p>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td> {{ strtoupper($applicant->patients->born_place) }}
                        , {{ monthToFullBulan($applicant->patients->born_date) }}</td>
                </tr>
                <tr>
                    <td>3.</td>
                    <td>Jenis kelamin</td>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td width="30%" align="center">
                                Pasarwajo, {{ date('d') }} {{ monthToBulan(date('m')) }} {{ date('Y') }} </td>
                        </tr>
                        <tr>
                            <td width="70%"></td>
                        ...
                        <tr>
                            <td width="60%"></td>
                            <td width="40%" align="center"><b><u>
                                        dr. {{ strtoupper($applicant->doctors->name) }} </u></b></td>
                        </tr>
                        <tr>
                            <td width="60%"></td>
