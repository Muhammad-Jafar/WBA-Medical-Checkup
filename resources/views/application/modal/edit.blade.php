                     ...
                     <div class="row">
                             ...
                             <div class="form-group row align-item-center">
                                 ...
                                 <div class="col-lg-7 col-8">
                                     <div class="input-group">
                                         <input type="text" class="form-control" name="height_body" id="height_body"
                                                aria-describedby="basic-addon2" placeholder="Tinggi badan">
                         ...
                         <div class="col-md-6 mb-3">
                             <div class="form-group row align-item-center">
                                 ...
                                 <div class="col-lg-7 col-8">
                                     <div class="input-group">
                                         <input type="text" class="form-control" name="mass_body" id="mass_body"
                                                aria-describedby="basic-addon2" placeholder="Berat badan">
                     ...
                     <div class="row">
                         <div class="col-md-6 mb-3">
                             <div class="form-group row align-item-center">
                                 ...
                                 <div class="col-lg-7 col-8">
                                     <input type="text" class="form-control" name="blod_type" id="blod_type"
                                 ...
                                 <div class="col-lg-7 col-8">
                                     <div class="input-group">
                                         <input type="text" class="form-control" name="blod_pressure" id="blod_pressure"
                                                aria-describedby="basic-addon2" placeholder="Tekanan darah">
                     ...
                     <div class="row">
                         <div class="col-md-6 mb-3">
                             <div class="form-group row align-item-center">
                                 ...
                                 <div class="col-lg-7 col-8">
                                     <div class="input-group">
                                         <input type="text" class="form-control" name="colesterol" id="colesterol"
                                                aria-describedby="basic-addon2" placeholder="Kolesterol">
                         ...
                         <div class="col-md-6 mb-3">
                             <div class="form-group row align-item-center">
                                 ...
                                 <div class="col-lg-7 col-8">
                                     <div class="input-group">
                                         <input type="text" class="form-control" name="blod_sugar" id="blod_sugar"
                                                aria-describedby="basic-addon2" placeholder="Gula darah">
                                         <span class="input-group-text" id="basic-addon2">mg/dL</span>
                                     </div>
                                 </div>
                             </div>
