<x-maz-sidebar :href="route('dashboard')" :logo="asset('images/logo/logo.png')">
    ...
    <x-maz-sidebar-item name="Permintaan" :link="route('dashboard')" icon="bi bi-collection-fill"></x-maz-sidebar-item>
    <x-maz-sidebar-item name="Master data" icon="bi bi-stack">
        <x-maz-sidebar-sub-item name="Pasien" :link="route('components.accordion')"></x-maz-sidebar-sub-item>
        <x-maz-sidebar-sub-item name="Dokter" :link="route('components.alert')"></x-maz-sidebar-sub-item>
    </x-maz-sidebar-item>
