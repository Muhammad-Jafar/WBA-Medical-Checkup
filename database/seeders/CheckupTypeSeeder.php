    ...
    public function run()
    {
        ...
        $data = [
            0 => [
                ...
                'description' => 'Pembuatan SKBS tanpa TB + BB'
            ],
            1 => [
                'name' => 'SKBS Paket 2',
                'abbreviated_word' => 'Paket 2',
                'description' => 'Pembuatan SKBS dengan TB + BB'
            ],
            2 => [
                'name' => 'SKBS Paket 3',
                'abbreviated_word' => 'Paket 3',
                'description' => 'Pembuatan SKBS dengan Paket 2 + tekanan darah + kolesterol + gula darah'
            ],
            3 => [
                'name' => 'SKBS Paket 4',
                'abbreviated_word' => 'Paket 4',
                'description' => 'Pembuatan SKBS dengan napza'
            ],
        ];
